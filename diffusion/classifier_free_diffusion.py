# Source from guided-diffusion (https://github.com/openai/guided-diffusion/blob/main/guided_diffusion/gaussian_diffusion.py)
...
class GaussianDiffusion:
    ...
    def p_mean_variance(
        ...
        assert th.isnan(model_output).int().sum() == 0, f"nan in tensor pred_eps when t = {t[0]}"
    ...
    def p_sample(
        ...
        """
        Sample x_{t-1} from the from p_{theta}(x_{t-1}|x_t) at t.
